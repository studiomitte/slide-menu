...
export class Slide {
  ...
  constructor(menuElem, options, anchorElem) {
    ...
    number++;
    this.name =
      (_b = (_a = this.anchorElem) === null || _a === void 0 ? void 0 : _a.textContent) !== null &&
      _b !== void 0
        ? _b
        : '';
    this.parentMenuElem =
      (_d =
        (_c = anchorElem === null || anchorElem === void 0 ? void 0 : anchorElem.parentElement) ===
          null || _c === void 0
          ? void 0
          : _c.closest('ul')) !== null && _d !== void 0
        ? _d
        : undefined;
    this.parent = (_e = this.parentMenuElem) === null || _e === void 0 ? void 0 : _e._slide;
    if (anchorElem) {
      anchorElem === null || anchorElem === void 0
        ? void 0
    ...
    this.isFoldable = !!(anchorElem === null || anchorElem === void 0
      ? void 0
      : anchorElem.classList.contains(CLASSES.hasFoldableSubmenu));
    if (this.isFoldable) {
  ...
  addBackLink(options = this.options) {
    ...
    backLink.innerHTML =
      ((_c = options.backLinkBefore) !== null && _c !== void 0 ? _c : '') +
      anchorText +
      ((_d = options.backLinkAfter) !== null && _d !== void 0 ? _d : '');
  ...
  addNavigatorButton(options) {
    ...
    const existingNavigator = Array.from(
      (_c =
        (_b = (_a = this.anchorElem) === null || _a === void 0 ? void 0 : _a.parentElement) ===
          null || _b === void 0
          ? void 0
          : _b.children) !== null && _c !== void 0
        ? _c
        : [],
    ).find((elem) => elem.classList.contains(CLASSES.navigator));
    const navigatorTag = 'button';
    const navigator =
      existingNavigator !== null && existingNavigator !== void 0
        ? existingNavigator
        : document.createElement(navigatorTag);
    navigator.classList.add(CLASSES.navigator);
    navigator.dataset.action =
      (_e = (_d = navigator.dataset) === null || _d === void 0 ? void 0 : _d.action) !== null &&
      _e !== void 0
        ? _e
        : Action.NavigateTo;
    navigator.dataset.arg =
      (_g = (_f = navigator.dataset) === null || _f === void 0 ? void 0 : _f.arg) !== null &&
      _g !== void 0
        ? _g
        : this.id;
    ...
    (_h = this.anchorElem) === null || _h === void 0
      ? void 0
      : _h.insertAdjacentElement('afterend', navigator);
  ...
  deactivate() {
    ...
    if (this.options.navigationButtons) {
      (_a = this.navigatorElem) === null || _a === void 0
        ? void 0
        : _a.setAttribute('aria-expanded', 'false');
    } else {
      (_b = this.anchorElem) === null || _b === void 0
        ? void 0
        : _b.setAttribute('aria-expanded', 'false');
    }
    return this;
  }
  activate() {
    ...
    if (this.options.navigationButtons) {
      ...
      (_b = this.anchorElem) === null || _b === void 0
        ? void 0
        : _b.setAttribute('aria-expanded', 'true');
    }
    return this;
  }
  setInvisible() {
  ...
  hasParent(possibleParentMenu) {
    return this.getAllParents().some(
      (p) =>
        p.id ===
        (possibleParentMenu === null || possibleParentMenu === void 0
          ? void 0
          : possibleParentMenu.id),
    );
  }
  /**
   *
  ...
  matches(idHrefOrSelector) {
    ...
    return !!(
      ...
      ((_a = this.anchorElem) === null || _a === void 0 ? void 0 : _a.id) ===
        idHrefOrSelector.replace('#', '') ||
