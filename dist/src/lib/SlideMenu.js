...
export class SlideMenu {
  constructor(elem, options) {
    ...
    this.menuTitleDefaultText =
      (_c =
        (_b = (_a = this.menuTitle) === null || _a === void 0 ? void 0 : _a.textContent) === null ||
        _b === void 0
          ? void 0
    ...
    this.navigateTo(
      (_d = this.defaultOpenTarget) !== null && _d !== void 0 ? _d : this.slides[0],
      false,
    );
  ...
  get defaultOpenTarget() {
    ...
    const defaultTargetSelector =
      (_d =
        (_c =
          (_b =
            (_a = this.menuElem.dataset.openDefault) !== null && _a !== void 0
              ? _a
              : this.menuElem.dataset.defaultTarget) !== null && _b !== void 0
            ? _b
            : this.menuElem.dataset.openTarget) !== null && _c !== void 0
          ? _c
          : this.menuElem.dataset.defaultOpenTarget) !== null && _d !== void 0
        ? _d
  ...
  getTargetSlideDynamically() {
    ...
    return currentPathItem !== null && currentPathItem !== void 0
      ? currentPathItem
      : currentHashItem;
  }
  open(animate = true) {
    var _a;
    const target =
      (_a = this.options.dynamicOpenDefault
        ? this.getTargetSlideDynamically()
        : this.defaultOpenTarget) !== null && _a !== void 0
        ? _a
        : this.activeSubmenu;
  ...
  show(animate = true) {
    ...
    (_a = document.querySelector('body')) === null || _a === void 0
      ? void 0
      : _a.classList.add(CLASSES.open);
  }
  /**
  ...
  close(animate = true) {
    ...
    (_a = document.querySelector('body')) === null || _a === void 0
      ? void 0
      : _a.classList.remove(CLASSES.open);
  }
  /**
  ...
  back(closeFold = false) {
    ...
    let nextMenu =
      (_b = (_a = this.activeSubmenu) === null || _a === void 0 ? void 0 : _a.parent) !== null &&
      _b !== void 0
        ? _b
        : rootSlide;
    if (closeFold) {
      this.activeSubmenu =
        (_d =
          (_c = this.activeSubmenu) === null || _c === void 0
            ? void 0
            : _c.getClosestUnfoldableSlide()) !== null && _d !== void 0
          ? _d
          : rootSlide;
      nextMenu =
        (_f = (_e = this.activeSubmenu) === null || _e === void 0 ? void 0 : _e.parent) !== null &&
        _f !== void 0
          ? _f
          : rootSlide;
      this.closeFold();
  ...
  navigateTo(target, runInForeground = true) {
    ...
    const isNavigatingBack =
      previousMenu === null || previousMenu === void 0 ? void 0 : previousMenu.hasParent(nextMenu);
    const isNavigatingForward =
      nextMenu === null || nextMenu === void 0 ? void 0 : nextMenu.hasParent(previousMenu);
    if (runInForeground) {
  ...
  setBodyTagSlideLevel(level) {
    ...
    (_a = document.querySelector('body')) === null || _a === void 0
      ? void 0
      : _a.setAttribute('data-slide-menu-level', level.toString());
  }
  setTabbing(nextMenu, firstUnfoldableParent, previousMenu, parents) {
    ...
    if (nextMenu.canFold()) {
      ...
      firstUnfoldableParent === null || firstUnfoldableParent === void 0
        ? void 0
    ...
    if (
      (previousMenu === null || previousMenu === void 0 ? void 0 : previousMenu.canFold()) &&
      !nextMenu.canFold()
    ) {
      // close fold
      this.closeFold();
  ...
  activateMenus(currentlyActiveMenus, isNavigatingBack, previousMenu, nextMenu) {
    const currentlyActiveIds = currentlyActiveMenus.map((menu) =>
    ...
    this.slides.forEach((slide) => {
      if (!currentlyActiveIds.includes(slide.id)) {
        ...
        if (
          isNavigatingBack &&
          slide.id === (previousMenu === null || previousMenu === void 0 ? void 0 : previousMenu.id)
        ) {
          return;
        }
        slide.deactivate();
  ...
  setSlideLevel(nextMenu, isNavigatingBack = false) {
    ...
    const navDecrement = !(nextMenu === null || nextMenu === void 0 ? void 0 : nextMenu.canFold())
      ? Number(isNavigatingBack)
      : 0;
  ...
  updateMenuTitle(nextMenu, firstUnfoldableParent) {
    ...
    if (this.menuTitle) {
      let anchorText =
        (_b =
          (_a = nextMenu === null || nextMenu === void 0 ? void 0 : nextMenu.anchorElem) === null ||
          _a === void 0
            ? void 0
            : _a.textContent) !== null && _b !== void 0
          ? _b
          : this.menuTitleDefaultText;
      const navigatorTextAfter =
        (_d = (_c = this.options) === null || _c === void 0 ? void 0 : _c.navigationButtons) !==
          null && _d !== void 0
          ? _d
          : '';
      const navigatorTextBefore =
        (_f = (_e = this.options) === null || _e === void 0 ? void 0 : _e.submenuLinkBefore) !==
          null && _f !== void 0
          ? _f
          : '';
      if (nextMenu.canFold() && firstUnfoldableParent) {
        anchorText =
          (_h =
            (_g = firstUnfoldableParent.anchorElem) === null || _g === void 0
              ? void 0
    ...
    document.addEventListener('keydown', (event) => {
      ...
      switch (event.key) {
        ...
        case 'Enter':
          ...
          if (
            elem === null || elem === void 0 ? void 0 : elem.classList.contains(CLASSES.navigator)
          )
            elem.click();
          break;
      }
  ...
  initMenu() {
    ...
    this.menuElem.addEventListener('keydown', (event) => {
      ...
      trapFocus(
        event,
        (_b = (_a = this.activeSubmenu) === null || _a === void 0 ? void 0 : _a.menuElem) !==
          null && _b !== void 0
          ? _b
          : this.menuElem,
        firstControl,
    ...
    const resizeObserver = new ResizeObserver((entries) => {
      ...
      if (bodyContentWidth < this.options.minWidthFold && this.isFoldOpen) {
        this.closeFold();
        const parents =
          (_a = this.activeSubmenu) === null || _a === void 0 ? void 0 : _a.getAllParents();
        const firstUnfoldableParent =
          parents === null || parents === void 0 ? void 0 : parents.find((p) => !p.canFold());
        this.setTabbing(
          (_b = this.activeSubmenu) !== null && _b !== void 0 ? _b : this.slides[0],
          firstUnfoldableParent,
          this.activeSubmenu,
          parents !== null && parents !== void 0 ? parents : [],
        );
        this.setSlideLevel(
          (_c = this.activeSubmenu) !== null && _c !== void 0 ? _c : this.slides[0],
        );
        this.setTabbing(
          (_d = this.activeSubmenu) !== null && _d !== void 0 ? _d : this.slides[0],
          undefined,
          undefined,
          [],
        );
      ...
      if (bodyContentWidth > this.options.minWidthFold && !this.isFoldOpen) {
        this.openFold();
        const parents =
          (_e = this.activeSubmenu) === null || _e === void 0 ? void 0 : _e.getAllParents();
        const firstUnfoldableParent =
          parents === null || parents === void 0 ? void 0 : parents.find((p) => !p.canFold());
        this.setTabbing(
          (_f = this.activeSubmenu) !== null && _f !== void 0 ? _f : this.slides[0],
          firstUnfoldableParent,
          this.activeSubmenu,
          parents !== null && parents !== void 0 ? parents : [],
        );
        this.setSlideLevel(
          (_g = this.activeSubmenu) !== null && _g !== void 0 ? _g : this.slides[0],
        );
      }
    });
...
document.addEventListener('click', (event) => {
  ...
  const menu =
    !target || target === 'this'
      ...
      : (_b = document.getElementById(target)) !== null && _b !== void 0
        ? _b
        : document.querySelector(target); // assumes #id
  if (!menu) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
  const arg = Object.keys(dataArgMapping).includes(
    (_d = dataArg === null || dataArg === void 0 ? void 0 : dataArg.toString()) !== null &&
      _d !== void 0
      ? _d
      : '',
  )
