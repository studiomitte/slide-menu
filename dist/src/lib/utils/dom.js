...
export function focusFirstTabAbleElemIn(elem) {
  var _a;
  const firstTabbaleElem = Array.from(
    (_a = elem === null || elem === void 0 ? void 0 : elem.querySelectorAll(TAB_ABLE_SELECTOR)) !==
      null && _a !== void 0
      ? _a
      : [],
  ).find((elem) => {
...
function isVisible(element) {
  ...
  for (let el = element; el && el !== document; el = el.parentNode) {
    ...
    if (
      ((_a = el.style) === null || _a === void 0 ? void 0 : _a.display) === 'none' ||
...
export function trapFocus(event, targetElement, firstElement, lastElement) {
  ...
  const firstFocusableElement =
    firstElement !== null && firstElement !== void 0 ? firstElement : focusableElements[0];
