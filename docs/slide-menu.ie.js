!(function (t) {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e) {
      var n,
        ...
        d = t.global,
        m = t.stat;
      if ((n = d ? r : m ? r[h] || c(h, {}) : (r[h] || {}).prototype))
        for (f in e) {
          if (
            ((p = e[f]),
  ...
  function (t, e, n) {
    ...
    t.exports = function (t) {
      var e,
        ...
        g = 0,
        E = s(v);
      if ((y && (m = r(m, d > 2 ? arguments[2] : void 0, 2)), null == E || (h == Array && a(E))))
        for (n = new h((e = c(v.length))); e > g; g++) u(n, g, y ? m(v[g], g) : v[g]);
      else
        for (p = (l = E.call(v)).next, n = new h(); !(f = p.call(l)).done; g++)
          u(n, g, y ? i(l, m, [f.value, g], !0) : f.value);
      return ((n.length = g), n);
    };
  },
  function (t, e) {
      ...
      o(function () {
        ...
        ? function (t, e) {
            for (var n = u(t), o = arguments.length, f = 1, l = a.f, p = c.f; o > f; )
              for (
                var v, h = s(arguments[f++]), d = l ? i(h).concat(l(h)) : i(h), m = d.length, y = 0;
                m > y;
              )
                ((v = d[y++]), (r && !p.call(h, v)) || (n[v] = h[v]));
            return n;
          }
        : f;
  },
  ...
  function (t, e, n) {
    ...
    var r = n(6),
      ...
      i = n(10);
    r(
      { target: 'String', proto: !0, forced: !n(85)('includes') },
      {
        includes: function (t) {
    ...
    t.exports = function (t, e, n, f, v, g, E) {
      ...
      if (
        (j &&
          ...
          h !== Object.prototype &&
            b.next &&
            (l || i(b) === h || (a ? a(b, h) : 'function' != typeof b[m] && u(b, m, y)),
            c(b, A, !0, !0),
            l && (p[A] = y))),
        'values' == v &&
          O &&
        ...
        if (((S = { values: w('values'), keys: g ? _ : w('keys'), entries: w('entries') }), E))
          for (x in S) (!d && !L && x in k) || s(k, x, S[x]);
        else r({ target: e, proto: !0, forced: d || L }, S);
      return S;
    };
  },
  function (t, e, n) {
        ...
        return function (v, h, d, m) {
          for (
            var y,
              ...
              w = 0,
              A = m || c,
              L = e ? A(v, x) : n ? A(v, 0) : void 0;
            x > w;
            w++
          )
            if ((p || w in b) && ((g = S((y = b[w]), w, E)), t))
              if (e) L[w] = g;
              else if (g)
                switch (t) {
                  case 3:
  ...
  function (t, e, n) {
    ...
    function a(t, e, n) {
      for (var r = []; t && null !== t.parentElement && (void 0 === n || r.length < n); )
    ...
    var s = {
      ...
      f = (function () {
        function t(e, n) {
          ...
          ((this.options = Object.assign({}, s, n)),
            (this.menuElem = e),
            (this.wrapperElem = document.createElement('div')),
            this.wrapperElem.classList.add(t.CLASS_NAMES.wrapper));
          ...
          (n = [
            {
              ...
              value: function (t) {
                ...
                if (
                  ((e = t ? 0 : this.options.position === o.Left ? '-100%' : '100%'),
                  (this.isOpen = t),
                  n)
                )
            ...
            },
            {
              ...
              value: function () {
                ...
                ((n || r) &&
                  Array.from(
                    this.wrapperElem.querySelectorAll('.'.concat(t.CLASS_NAMES.decorator)),
                  ).forEach(function (t) {
                    t.parentElement && t.parentElement.removeChild(t);
                  }),
                  o &&
                    Array.from(
                      this.wrapperElem.querySelectorAll('.'.concat(t.CLASS_NAMES.control)),
                    ).forEach(function (t) {
                      var e = c(t, 'li');
                  ...
                  this.menuElem.querySelectorAll('ul').forEach(function (t) {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                Array.from(
                  this.wrapperElem.querySelectorAll('.'.concat(t.CLASS_NAMES.active)),
                ).forEach(function (e) {
                ...
                (o >= 0 &&
                  o !== this.level &&
                  ((this.level = o), this.moveSlider(this.wrapperElem, 100 * -this.level)),
              ...
              value: function () {
                ...
                if (!(this.isAnimating || (e === r.Backward && 0 === this.level))) {
                  ...
                  (this.triggerEvent(c),
                    ...
                    this.moveSlider(this.wrapperElem, o));
                }
              },
            },
            {
                  ...
                  if (null !== n.parentElement) {
                    ...
                    if (r) {
                      ...
                      if ((e.addLinkDecorators(n), e.options.showBackLink)) {
                        ...
                        ((s.innerHTML = c + o + u),
                          s.classList.add(t.CLASS_NAMES.backlink, t.CLASS_NAMES.control),
                          s.setAttribute('data-action', i.Back));
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (r) {
                  ...
                  (i.classList.add(t.CLASS_NAMES.decorator),
                    (i.innerHTML = r),
    ...
    ((f.NAMESPACE = 'slide-menu'),
      ...
      document.addEventListener('click', function (t) {
        if (t.target instanceof HTMLElement) {
          var e = t.target.className.includes(f.CLASS_NAMES.control)
            ? t.target
            : c(t.target, '.'.concat(f.CLASS_NAMES.control));
