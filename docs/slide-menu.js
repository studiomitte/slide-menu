  ...
  function (t, e, n) {
    ...
    (t.exports = function (t, e, n, s) {
      ...
      ('function' == typeof n &&
        ...
        t !== r
          ? (a ? !p && t[e] && (u = !0) : delete t[e], u ? (t[e] = n) : o(t, e, n))
          : u
            ? (t[e] = n)
            : c(e, n));
      ...
      o(function () {
        ...
        ? function (t, e) {
            for (var n = a(t), o = arguments.length, l = 1, f = c.f, p = s.f; o > l; )
              for (
                var h, m = u(arguments[l++]), d = f ? i(m).concat(f(m)) : i(m), v = d.length, g = 0;
                v > g;
              )
      ...
      r(
        ...
        function () {
          ...
          return (
            ...
            e +
            '/' +
            String(void 0 === n && t instanceof RegExp && !('flags' in s) ? c.call(t) : n)
          );
        },
        { unsafe: !0 },
      );
  ...
  function (t, e, n) {
    ...
    class u {
      ...
      toggle(t, e = !0) {
        ...
        if (
          ((n = t ? 0 : this.options.position === o.Left ? '-100%' : '100%'), (this.isOpen = t), e)
        )
      ...
      destroy() {
        ...
        if (t || e) {
          Array.from(
            this.wrapperElem.querySelectorAll('.'.concat(u.CLASS_NAMES.decorator)),
          ).forEach((t) => {
            t.parentElement && t.parentElement.removeChild(t);
          });
        }
        if (n) {
          Array.from(this.wrapperElem.querySelectorAll('.'.concat(u.CLASS_NAMES.control))).forEach(
            (t) => {
              const e = s(t, 'li');
      ...
      navigateTo(t) {
        ...
        Array.from(this.wrapperElem.querySelectorAll('.'.concat(u.CLASS_NAMES.active))).forEach(
          (t) => {
        ...
        (n >= 0 &&
          n !== this.level &&
          ((this.level = n), this.moveSlider(this.wrapperElem, 100 * -this.level)),
          e.forEach((t) => {
